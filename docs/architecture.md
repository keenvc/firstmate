...
That keeps spawn launch compatible across claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, cline, and openhands while preserving the requested profile for later audit.
...
It is also the one owner of the no-mistakes `--intent` contract those workers follow, and of the definition of done's before/after evidence-pair requirement.
