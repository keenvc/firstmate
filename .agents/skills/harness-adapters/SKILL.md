...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, cline, and openhands.
...
Muse, Gemini, AGY, Cline, and OpenHands are verified only for crewmate and scout work, never a secondmate or primary.
